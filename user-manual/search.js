...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.6.3", section: "What's New", text: 'Windows fix antivirus blocking onedir bundling DLLs install directory. Windows better error diagnostics backend startup crash detection stderr capture troubleshooting. Splash screen OPEN DRAFT text spacing fix.', url: 'index.html#whats-new' },
