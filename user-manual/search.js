...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.4.0", section: "What's New", text: 'Card view list grid toggle content preview. Inline rename double-click project screenplay. Duplicate screenplay copy. Export file list FDX Fountain PDF odraft. Native odraft format lossless import export. Zip import export project archive. Pinned section dedicated top sorting unpinned. Improved readability fonts spacing. Actions menu three-dot rename duplicate export delete. Light theme fix properties dialog.', url: 'index.html#whats-new' },
