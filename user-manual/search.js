...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.10.0", section: "What's New", text: 'Page preview thumbnails scroll sync scene filters character location time of day scene length indicator improved readability light theme touch friendly.', url: 'index.html#whats-new' },
