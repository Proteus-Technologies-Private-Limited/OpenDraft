...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.15.1", section: "What's New", text: 'iPad touch UX comfortable mode larger tap targets iPadOS detection. Element type shortcuts Cmd Ctrl 1-8 switch scene heading action character. Collaboration password show hide toggle persistent display name.', url: 'index.html#whats-new' },
