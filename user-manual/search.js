...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.6.7", section: "What's New", text: 'Windows fix DLL loading relaunch sidecar AppData Defender exclusion PowerShell API Tamper Protection.', url: 'index.html#whats-new' },
