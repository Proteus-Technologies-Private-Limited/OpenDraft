...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.22.0", section: "What's New", text: 'Fade In import fadein osf open screenplay format. Paste as Fountain clipboard emphasis italic bold underline forced action lyrics centred page break. Automatic backups timestamped folder recover snapshot. Hard line breaks shift enter. Save prompt before new open import. Unsaved changes dialog auto-save catch up. Faster panel search navigation. Instant scroll scene character note tag match. Save reliability windows WAL onedrive detection diagnostics. Storage fallback recovery. Mobile dialogs soft keyboard. Insert images title page editor mores continueds. Treatment documents location database act sequence structure version diff multi-format templates DOCX import export script statistics WGA fields scene navigator search synopsis character relationships cloud projects per-user files self-hosted docker.', url: 'index.html#whats-new' },
