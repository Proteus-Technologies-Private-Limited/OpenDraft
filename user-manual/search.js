...
(function () {
  ...
  const searchIndex = [
    ...
    { page: 'Home', title: "What's New in v0.7.0", section: "What's New", text: 'Local SQLite storage no Python sidecar remote collaboration server JWT Google OAuth beat board improvements link previews general notes iOS mobile fixes.', url: 'index.html#whats-new' },
