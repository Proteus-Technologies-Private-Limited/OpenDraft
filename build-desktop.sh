...
#
# The desktop app uses local SQLite for storage (no Python sidecar).
...
# Signing identity — used by Tauri for app bundle signing
...
# Desktop uses local SQLite — no Python sidecar needed.
echo ""
